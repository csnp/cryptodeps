...
var remediationDB = map[string]Remediation{
	...
	"Ed25519": {
		...
		Notes: "Ed25519 has similar API to ML-DSA, making migration relatively straightforward.",
	},
	"Ed448": {
	...
	// JWT/JWS Algorithms
	"RS256": {
		Summary:      "Migrate JWT signing to ML-DSA or hybrid schemes",
		Replacement:  "ML-DSA-65 (when library support available)",
		NISTStandard: "FIPS 204",
		Timeline:     "short-term",
		Effort:       "medium",
		Notes:        "RS256 uses RSA-2048 which is quantum-vulnerable. Consider EdDSA as interim step.",
	},
	"RS384": {
		Summary:      "Migrate JWT signing to ML-DSA",
		Replacement:  "ML-DSA-65",
		NISTStandard: "FIPS 204",
		Timeline:     "short-term",
		Effort:       "medium",
		Notes:        "RSA-based JWT signatures need PQC migration.",
	},
	"RS512": {
		Summary:      "Migrate JWT signing to ML-DSA",
		Replacement:  "ML-DSA-87",
	...
	"ES256": {
		...
		Timeline:     "short-term",
		Effort:       "medium",
		Notes:        "ECDSA-based JWT signatures are quantum-vulnerable.",
	},
	"ES384": {
		Summary:      "Migrate JWT signing to ML-DSA",
		Replacement:  "ML-DSA-65",
	...
	"HS256": {
		Summary:      "Consider HS384/HS512 for stronger post-quantum security",
		Replacement:  "HS384 or HS512 (optional)",
		NISTStandard: "",
		Timeline:     "medium-term",
		Effort:       "low",
		Notes:        "HMAC-SHA256 provides partial quantum resistance. Larger variants offer more margin.",
	},
	"HS384": {
		Summary:      "Already quantum-safe",
		Replacement:  "No change needed",
		...
		Timeline:     "none",
		Effort:       "none",
		Notes:        "HMAC-SHA384 provides strong post-quantum security.",
	},
	"HS512": {
		Summary:      "Already quantum-safe",
		Replacement:  "No change needed",
		...
		Timeline:     "none",
		Effort:       "none",
		Notes:        "HMAC-SHA512 provides strong post-quantum security.",
	},
	"EdDSA": {
		Summary:      "Migrate to ML-DSA when available",
		Replacement:  "ML-DSA-65",
		NISTStandard: "FIPS 204",
		Timeline:     "short-term",
		Effort:       "low",
		Notes:        "EdDSA (Ed25519) is quantum-vulnerable but a good interim from RSA/ECDSA.",
	},
